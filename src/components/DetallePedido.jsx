...
function DetallePedido({ items, checkout, mostrarControles = true }) {
        ...
        <CardContent>
          ...
          {items.map((publicacion) => (
            <Box
              ...
              sx={{
                display: 'flex', justifyContent: 'space-between', marginBottom: '10px', marginTop: '10px',
              }}
            >
              <Typography variant='body1' sx={{ fontSize: '1.1em' }}>
                {publicacion.idProductoNavigation.nombre}
                {' '}
                (
              ...
              <Typography variant='body1' sx={{ fontSize: '1.1em' }}>
                {' '}
                {formatPrice(publicacion.precio * publicacion.cantidad)}
              </Typography>
            </Box>
          ))}
          <Divider sx={{ mt: 5 }} />

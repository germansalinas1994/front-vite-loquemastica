import {
  Box, Card, Grid, TextField, Button, Typography,
} from '@mui/material'
...
function MiCuenta() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <Box sx={{
        display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 15,
      }}
      >
        <Grid
          container
          ...
          component={Card}
          sx={{
            width: '80%', maxWidth: '1200px', height: 1, maxHeight: '1000px', borderRadius: 4,
          }}
        >
          <Grid item xs={12}>
            <Box sx={{
            ...
            >
              ...
              <Tooltip title='Editar datos'>
                ...
                {' '}
                {/* Muestra el ícono de lápiz solo si no está en modo edición */}
              </Tooltip>
            </Box>
          </Grid>
